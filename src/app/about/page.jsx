    ...
    <div>
        ...
        <div className='bg-[#FAFAFA] md:p-20 p-6 text-[#111111] md:flex justify-center gap-8'>
            <div className="mt-10">
                ...
                <div className='mt-10'>
                    <hr className="border-[#80BB66] mb-3 border-t w-[100px]" />
                    <h1 className="text-2xl font-bold mt-4 max-w-[400px]">Our Vision</h1>  
                    <p className='text-sm mt-4'>A world where everyone matters and no one is left behind.</p>
                </div>
                <Link href="/whatwedo">
        ...
        <div className="bg-[#111111] md:p-20 px-6 py-10 text-center">
            <div className="mb-10"> 
                <p className="text-[#A3EF83]">Everyone Matters Foundation Impact Till Date</p>
            </div>
            ...
            <div className="md:grid grid-cols-3 text-white space-y-8 md:space-y-0">
                <div className="md:grid grid-rows-3 space-y-1">
                    ...
                    <p className="text-sm font-extralight font-serif md:px-20 px-16">Our work has impacted communities across 2 continents.</p>
                </div>
                <div className="md:grid grid-rows-3 space-y-1">
                    <p className="font-bold text-4xl">120</p>
                    <p className="font-bold text-xl">Communities</p>
                    <p className="text-sm font-extralight font-serif md:px-20 px-16">We have successfully reached over 120 communities since 2024.</p>
                </div>
                <div className="md:grid grid-rows-3 space-y-1">
                    <p className="font-bold text-4xl">500k</p>
                    <p className="font-bold text-xl">Individuals</p>
                    <p className="text-sm font-extralight font-serif md:px-20 px-10">We have provided a wide range of essential support to individuals in need.</p>
                </div>
            </div>
        </div>
        ...
        <div className="bg-white lg:px-56 md:px-32 md:py-20 p-6 py-10 text-[#111111]">
            ...
            <div>
                <div className="mt-6">
                    ...
                    <p className='text-sm mb-6'>Our actions are driven by a deep sense of compassion, fueled by a deep understanding of human suffering. We are committed to alleviating hardship wherever we find it, whether it stems from natural disasters, poverty, or conflict. This commitment motivates us to provide immediate relief, support recovery, and work towards a world where everyone has the opportunity to live with dignity.</p> 
                    <hr className="border-[#80BB66] mb-3 border-t" />
                </div>
                <div className="mt-6">
                    <h3 className="text-2xl font-bold mb-3">Inclusion and Equality</h3>
                    <p className='text-sm mb-6'>We stand firmly for the principles of inclusivity and equality. Our efforts ensure that our assistance and support are accessible to all, without discrimination. We work tirelessly to create opportunities that benefit everyone, regardless of their background, status, or circumstances.</p> 
                    <hr className="border-[#80BB66] mb-3 border-t" />
                </div>
                <div className="mt-6">
                    <h3 className="text-2xl font-bold mb-3">Sustainability and Environmental Responsibility</h3>
                    <p className='text-sm mb-6'>We are deeply committed to nurturing sustainable communities through environmentally responsible approaches. We believe in building thriving communities that coexist harmoniously with the environment.</p> 
                    <hr className="border-[#80BB66] mb-3 border-t" />
                </div>
                <div className="mt-6">
                    <h3 className="text-2xl font-bold mb-3">Empowerment and Advocacy</h3>
                    <p className='text-sm mb-6'>We believe that strong community voices are essential in enhancing the delivery of essential services, transparency and improving overall well-being.</p> 
                </div>
            </div>
        </div>
        ...
        <div className='bg-white md:p-20 p-6 text-[#111111] md:flex justify-center gap-8'>
            <div className="text-center flex flex-col items-center">
                ...
                <p className='text-sm mb-8 max-w-[650px]'>You can help build a world where everyone matters. Join our network of partners and leverage your resources to support our mission.</p>
